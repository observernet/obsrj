...
package org.obsrj.tools;

import org.obsrj.core.*;
import org.obsrj.crypto.*;
import org.obsrj.store.*;

import org.obsrj.net.discovery.DnsDiscovery;
import org.obsrj.params.MainNetParams;
import org.obsrj.params.RegTestParams;
import org.obsrj.params.TestNet3Params;
import org.obsrj.protocols.payments.PaymentProtocol;
import org.obsrj.protocols.payments.PaymentProtocolException;
import org.obsrj.protocols.payments.PaymentSession;
import org.obsrj.script.ScriptBuilder;
import org.obsrj.uri.ObsrURI;
import org.obsrj.uri.BitcoinURIParseException;
import org.obsrj.utils.BriefLogFormatter;
import org.obsrj.wallet.DeterministicSeed;
import org.obsrj.wallet.DeterministicUpgradeRequiredException;
import org.obsrj.wallet.DeterministicUpgradeRequiresPassword;
...
import static org.obsrj.core.Coin.parseCoin;
        ...
        if (location.startsWith("http") || location.startsWith(CoinDefinition.coinURIScheme)) {
            try {
                ...
                if (location.startsWith("http")) {
                    ...
                    ObsrURI paymentRequestURI = new ObsrURI(location);
