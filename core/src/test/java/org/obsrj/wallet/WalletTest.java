...
import org.obsrj.core.PeerAddress;
...
import org.obsrj.core.VerificationException;
import org.obsrj.core.TransactionConfidence.ConfidenceType;
import org.obsrj.crypto.*;
import org.obsrj.testing.*;
import org.obsrj.script.Script;
import org.obsrj.script.ScriptBuilder;
import org.obsrj.signers.StatelessTransactionSigner;
import org.obsrj.signers.TransactionSigner;
import org.obsrj.store.BlockStoreException;
import org.obsrj.store.MemoryBlockStore;
import org.obsrj.utils.ExchangeRate;
import org.obsrj.utils.Fiat;
import org.obsrj.utils.Threading;
import org.obsrj.wallet.Wallet.BalanceType;
import org.obsrj.wallet.WalletTransaction.Pool;
import org.obsrj.wallet.listeners.KeyChainEventListener;
...
import org.obsrj.wallet.listeners.WalletCoinsSentEventListener;
...
import org.obsrj.wallet.Protos.Wallet.EncryptionType;
...
import static org.obsrj.core.Coin.*;
import static org.obsrj.core.Utils.HEX;
...
public class WalletTest extends TestWithWallet {
    ...
    public void isConsistent_duplicates() throws Exception {
        ...
        Transaction tx = FakeTxBuilder.createFakeTx(PARAMS, COIN, myAddress);
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: obsrj won't check in SPV mode and this is easier than other mutations.
    ...
    public void pending1() throws Exception {
        ...
        flags[0] = false;
        flags[1] = false;
        Transaction irrelevant = FakeTxBuilder.createFakeTx(PARAMS, nanos, OTHER_ADDRESS);
    ...
    public void watchingScriptsSentFrom() throws Exception {
        ...
        Transaction t1 = FakeTxBuilder.createFakeTx(PARAMS, CENT, watchedAddress);
        Transaction t2 = FakeTxBuilder.createFakeTx(PARAMS, COIN, OTHER_ADDRESS);
        sendMoneyToWallet(AbstractBlockChain.NewBlockType.BEST_CHAIN, t1);
    ...
    public void removeScriptsBloomFilter() throws Exception {
        ...
        for (Address addr : addressesForRemoval) {
            Transaction t1 = FakeTxBuilder.createFakeTx(PARAMS, CENT, addr);
            TransactionOutPoint outPoint = new TransactionOutPoint(PARAMS, 0, t1);
    ...
    public void marriedKeychainBloomFilter() throws Exception {
        ...
        Transaction t1 = FakeTxBuilder.createFakeTx(PARAMS, CENT, address);
        TransactionOutPoint outPoint = new TransactionOutPoint(PARAMS, 0, t1);
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("obsrj-unit-test", null);
        ...
        Transaction t1 = FakeTxBuilder.createFakeTx(PARAMS, valueOf(5, 0), key);
        if (wallet.isPendingTransactionRelevant(t1))
            wallet.receivePending(t1, null);
    ...
    public void outOfOrderPendingTxns() throws Exception {
        ...
        Coin value = COIN;
        Transaction a = FakeTxBuilder.createFakeTx(PARAMS, value, myAddress);
        ...
        a = FakeTxBuilder.roundTripTransaction(PARAMS, a);
        b = FakeTxBuilder.roundTripTransaction(PARAMS, b);
    ...
    public void feeSolverAndCoinSelectionTest_dustySendRequested() throws Exception {
        ...
        Transaction tx1 = FakeTxBuilder.createFakeTx(PARAMS, SATOSHI, myAddress);
        Transaction tx2 = FakeTxBuilder.createFakeTx(PARAMS, SATOSHI, myAddress);
        assertNotEquals(tx1.getHash(), tx2.getHash());
        Transaction tx3 = FakeTxBuilder.createFakeTx(PARAMS, SATOSHI.multiply(10), myAddress);
    ...
    public void basicCategoryStepTest() throws Exception {
        ...
        while (i <= 100) {
            Transaction tx = FakeTxBuilder.createFakeTxWithChangeAddress(PARAMS, tenThousand, myAddress, OTHER_ADDRESS);
        ...
        Transaction tx1 = FakeTxBuilder.createFakeTxWithChangeAddress(PARAMS, tenThousand, myAddress, OTHER_ADDRESS);
        ...
        // Give us one more input...
        Transaction tx2 = FakeTxBuilder.createFakeTxWithChangeAddress(PARAMS, tenThousand, myAddress, OTHER_ADDRESS);
        ...
        while (wallet.getBalance().compareTo(CENT.multiply(2)) < 0) {
            Transaction tx3 = FakeTxBuilder.createFakeTxWithChangeAddress(PARAMS, tenThousand, myAddress, OTHER_ADDRESS);
        ...
        // Give us one more input...
        Transaction tx4 = FakeTxBuilder.createFakeTxWithChangeAddress(PARAMS, tenThousand, myAddress, OTHER_ADDRESS);
    ...
    public void testCategory2WithChange() throws Exception {
        ...
        while (i <= CENT.divide(Transaction.REFERENCE_DEFAULT_MIN_TX_FEE.multiply(10))) {
            Transaction tx = FakeTxBuilder.createFakeTxWithChangeAddress(PARAMS, Transaction.REFERENCE_DEFAULT_MIN_TX_FEE.multiply(10), myAddress, OTHER_ADDRESS);
            tx.getInput(0).setSequenceNumber(i++); // Keep every transaction unique
            wallet.receiveFromBlock(tx, block, AbstractBlockChain.NewBlockType.BEST_CHAIN, i);
        }
    ...
    public void testCompleteTxWithExistingInputs() throws Exception {
        ...
        StoredBlock block = new StoredBlock(FakeTxBuilder.makeSolvedTestBlock(blockStore, OTHER_ADDRESS), BigInteger.ONE, 1);
        Transaction tx1 = FakeTxBuilder.createFakeTx(PARAMS, COIN, myAddress);
        wallet.receiveFromBlock(tx1, block, AbstractBlockChain.NewBlockType.BEST_CHAIN, 0);
        Transaction tx2 = FakeTxBuilder.createFakeTx(PARAMS, COIN, myAddress);
        assertNotEquals(tx1.getHash(), tx2.getHash());
        wallet.receiveFromBlock(tx2, block, AbstractBlockChain.NewBlockType.BEST_CHAIN, 1);
        Transaction tx3 = FakeTxBuilder.createFakeTx(PARAMS, CENT, myAddress);
    ...
    public void testEmptyRandomWallet() throws Exception {
        ...
        for (int i = 0; i < rng.nextInt(100) + 1; i++) {
            Transaction tx = FakeTxBuilder.createFakeTx(PARAMS, Coin.valueOf(rng.nextInt((int) COIN.value)), myAddress);
            wallet.receiveFromBlock(tx, block, AbstractBlockChain.NewBlockType.BEST_CHAIN, i);
        }
    ...
    public void testEmptyWallet() throws Exception {
        // Add exactly 0.01
        StoredBlock block = new StoredBlock(FakeTxBuilder.makeSolvedTestBlock(blockStore, OTHER_ADDRESS), BigInteger.ONE, 1);
        Transaction tx = FakeTxBuilder.createFakeTx(PARAMS, CENT, myAddress);
        wallet.receiveFromBlock(tx, block, AbstractBlockChain.NewBlockType.BEST_CHAIN, 0);
        SendRequest request = SendRequest.emptyWallet(OTHER_ADDRESS);
        wallet.completeTx(request);
        ...
        tx = FakeTxBuilder.createFakeTx(PARAMS, CENT, myAddress);
        wallet.receiveFromBlock(tx, block, AbstractBlockChain.NewBlockType.BEST_CHAIN, 0);
        tx = FakeTxBuilder.createFakeTx(PARAMS, CENT, myAddress);
    ...
    public void childPaysForParent() throws Exception {
        ...
        Transaction toMe = FakeTxBuilder.createFakeTxWithoutChangeAddress(PARAMS, COIN, myAddress);
        ...
        Transaction toMeWithoutFee = FakeTxBuilder.createFakeTxWithoutChangeAddress(PARAMS, COIN, myAddress);
    ...
    public void riskAnalysis() throws Exception {
        ...
        final Transaction tx = FakeTxBuilder.createFakeTx(PARAMS, COIN, myAddress);
    ...
    public void transactionInBlockNotification() {
        ...
        final Transaction tx2 = FakeTxBuilder.createFakeTx(PARAMS, COIN, OTHER_ADDRESS);
        wallet.receivePending(tx2, null);
    ...
    public void totalReceivedSent() throws Exception {
        ...
        Transaction toMe1 = FakeTxBuilder.createFakeTxWithoutChangeAddress(PARAMS, COIN.multiply(2), myAddress);
        Transaction toMe2 = FakeTxBuilder.createFakeTxWithoutChangeAddress(PARAMS, COIN.multiply(2), myAddress);
