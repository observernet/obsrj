...
package org.obsrj.protocols.channels;

import org.obsrj.core.*;
import org.obsrj.testing.TestWithWallet;
...
import static org.obsrj.protocols.channels.PaymentChannelCloseException.CloseReason;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.obsrj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
