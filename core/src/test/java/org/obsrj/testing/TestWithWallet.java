...
package org.obsrj.testing;

import org.obsrj.core.*;
import org.obsrj.params.UnitTestParams;
...
import static org.obsrj.testing.FakeTxBuilder.createFakeBlock;
import static org.obsrj.testing.FakeTxBuilder.createFakeTx;
...
public class TestWithWallet {
    ...
    protected Transaction sendMoneyToWallet(Wallet wallet, AbstractBlockChain.NewBlockType type, Transaction... transactions)
        ...
        if (type == null) {
            ...
            FakeTxBuilder.BlockPair bp = FakeTxBuilder.createFakeBlock(blockStore, Block.BLOCK_HEIGHT_GENESIS, transactions);
            for (Transaction tx : transactions)
    ...
    protected Transaction sendMoneyToWallet(Wallet wallet, AbstractBlockChain.NewBlockType type, Coin value, Address toAddress) throws VerificationException {
        return sendMoneyToWallet(wallet, type, FakeTxBuilder.createFakeTx(PARAMS, value, toAddress));
    }
    ...
    protected Transaction sendMoneyToWallet(Wallet wallet, AbstractBlockChain.NewBlockType type, Coin value, ECKey toPubKey) throws VerificationException {
        return sendMoneyToWallet(wallet, type, FakeTxBuilder.createFakeTx(PARAMS, value, toPubKey));
    }
