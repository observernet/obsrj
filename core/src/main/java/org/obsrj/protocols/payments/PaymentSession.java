...
package org.obsrj.protocols.payments;

import org.obsrj.core.*;
import org.obsrj.uri.ObsrURI;

import org.obsrj.crypto.TrustStoreLoader;
import org.obsrj.params.MainNetParams;
import org.obsrj.protocols.payments.PaymentProtocol.PkiVerificationData;
 ...
 *
 * <ul>
 * <li>A {@link ObsrURI} object that conforms to BIP 0072</li>
 * <li>A url where the {@link Protos.PaymentRequest} can be fetched</li>
 * <li>Directly with a {@link Protos.PaymentRequest} object</li>
 * </ul>
 *
 * <p>If initialized with a ObsrURI or a url, a network request is made for the payment request object and a
...
public class PaymentSession {
     ...
     * uri is a BIP-72-style ObsrURI object that specifies where the {@link Protos.PaymentRequest} object may
     ...
     * be verified.</p>
     */
    public static ListenableFuture<PaymentSession> createFromBitcoinUri(final ObsrURI uri) throws PaymentProtocolException {
     ...
     */
    public static ListenableFuture<PaymentSession> createFromBitcoinUri(final ObsrURI uri, final boolean verifyPki)
     ...
     */
    public static ListenableFuture<PaymentSession> createFromBitcoinUri(final ObsrURI uri, final boolean verifyPki, @Nullable final TrustStoreLoader trustStoreLoader)
            throws PaymentProtocolException {
        String url = uri.getPaymentRequestUrl();
        if (url == null)
            throw new PaymentProtocolException.InvalidPaymentRequestURL("No payment request URL (r= parameter) in ObsrURI " + uri);
        try {
