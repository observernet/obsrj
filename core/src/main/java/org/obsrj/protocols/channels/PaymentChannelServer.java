    ...
    private void receiveVersionMessage(Protos.TwoWayChannelMessage msg) throws VerificationException {
        ...
        switch (majorVersion) {
            ...
            case 2:
                ...
                break;
            default:
                error("Protocol version " + majorVersion + " not supported", Protos.Error.ErrorCode.NO_ACCEPTABLE_VERSION, PaymentChannelCloseException.CloseReason.NO_ACCEPTABLE_VERSION);
                break;
        }
