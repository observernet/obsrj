...
public class PaymentChannelClient implements IPaymentChannelClient {
    ...
    @Nullable
    @GuardedBy("lock")
    private PaymentChannelCloseException.CloseReason receiveInitiate(Protos.Initiate initiate, Coin contractValue, Protos.Error.Builder errorBuilder)
            ...
            try {
                switch (msg.getType()) {
                    ...
                    case ERROR:
                        ...
                        setIncreasePaymentFutureIfNeeded(PaymentChannelCloseException.CloseReason.REMOTE_SENT_ERROR, msg.getError().getCode().name());
