...
import org.obsrj.net.AbstractTimeoutHandler;
import org.obsrj.net.NioClient;
import org.obsrj.net.NioClientManager;

import org.obsrj.net.StreamConnection;
...
public class Peer extends PeerSocketHandler {
     ...
     * or
     * {@link NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    protected void processMessage(Message m) throws Exception {
        ...
        //main.cpp 5763     // : We use certain sporks during IBD, so check to see if they are
...
//        }
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // obsrj is a client mode implementation. That means there's not much point in us talking to other client
