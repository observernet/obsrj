...
import org.obsrj.core.listeners.*;
import org.obsrj.crypto.DRMWorkaround;
import org.obsrj.net.BlockingClientManager;
import org.obsrj.net.ClientConnectionManager;
import org.obsrj.net.FilterMerger;
import org.obsrj.net.NioClientManager;
import org.obsrj.net.discovery.*;
import org.obsrj.script.Script;
import org.obsrj.utils.ContextPropagatingThreadFactory;
import org.obsrj.utils.ExponentialBackoff;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of obsrj fixes the known
     ...
     * and easy way for a user to upgrade a obsrj based app running in SPV mode to fully validating security.
     */
