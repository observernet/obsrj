...
import org.obsrj.protocols.channels.StoredPaymentChannelClientStates;
import org.obsrj.protocols.channels.StoredPaymentChannelServerStates;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV obsrj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit obsrj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing obsrj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * {@link org.obsrj.core.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called
     ...
     * block sync faster for new users - please refer to the documentation on the obsrj website for further details.
     */
