...
import org.obsrj.crypto.KeyCrypter;
import org.obsrj.crypto.KeyCrypterScrypt;
 ...
 * format is defined by the <tt>wallet.proto</tt> file in the obsrj source distribution.<p>
 *
...
public class WalletProtobufSerializer {
    ...
    private void readConfidence(final NetworkParameters params, final Transaction tx,
        ...
        switch (confidenceProto.getType()) {
            ...
            case IN_CONFLICT: confidenceType = TransactionConfidence.ConfidenceType.IN_CONFLICT; break;
            case UNKNOWN:
                // Fall through.
            default:
