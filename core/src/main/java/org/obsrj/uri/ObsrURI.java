...
import org.obsrj.params.AbstractBitcoinNetParams;
...
public class ObsrURI {
    ...
    /**
     * Constructs a new URI from the given string. Can be for any network.
     *
     ...
     */
    public ObsrURI(String uri) throws BitcoinURIParseException {
        this(null, uri);
    }
     ...
     */
    public ObsrURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        checkNotNull(input);
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("obsrURI[");
        boolean first = true;
